...
from .models import Transaction, employee_initializer
...
# daily_work = DailyWork.objects.all()
# def calculate_employees_income(daily_work):
#     total_income = 0
#     employee_income = daily_work.commision_rate / 100 * daily_work.total_amount
#     total_income += employee_income
#     return total_income

# def my_view(request):
#     daily_work = DailyWork.objects.all()
#     income = calculate_employees_income(daily_work)
#     context = {
#         'income': income,
#     }
#     return render(request, 'Dashboard/index.html', context)
