...
class Manager(models.Model):
    ...
    employee_lever = models.CharField(max_length=100, choices=EMPLOYEE_LEVER)
    profile_image = models.ImageField(upload_to='upload/',  default = 'a.png')
...
class Employees(models.Model):
    ...
    salary_type=models.CharField(max_length=255,blank=True, null=True, choices=SALARY_TYPE_CHOICES)
